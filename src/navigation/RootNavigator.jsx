...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://fresh-core-plus.site/`;
  const URL_IDENTIFAIRE = `UGARYB3F`;
  ...
  OneSignal.initialize('990c917a-ccc3-42e2-83e9-61435822bfcd');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2026-02-06T08:08:00'); //дата з якої поч працювати webView
